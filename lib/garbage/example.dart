...
// import 'package:userapp/garbage/scroll_controller.dart';
//
...
//                 listViewController.position = Get.find<ScrollPositionController>().getScrollPosition(index: index);
//               },
//               itemBuilder: (_, i) {
//                 return GetBuilder<ScrollPositionController>(
//                     init: Get.put(ScrollPositionController(len: categoryController.categoryList.length)),
//                     builder: (context) {
//                       return ListView.builder(
//                           controller: listViewController,
//                           itemCount: 15,
//                           itemBuilder: (_, j) {
//                             context.setScrollPosition(index: j, position: listViewController.position.pixels);
//                             return Container(
//                               height: 120,
